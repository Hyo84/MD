...
// 개인 효과는 유닛마다 따로. 아군 전체/근처 오라는 효과 ID당 최댓값만(중첩 안 됨).
...
const TIERS = {
  1: [
    ...
    { hp: 56, atk: 5.6, stop: 4.14, name: '밀지마요 I', desc: '전선 진격 +10% (중첩 안 됨)', set: { militiaAdvance: 0.10 } },
    ...
    { hp: 68, atk: 6.8, stop: 4.35, name: '밀지마요 II', desc: '전선 진격 +20% (중첩 안 됨)', set: { militiaAdvance: 0.20 } },
    ...
    { hp: 80, atk: 8.0, stop: 4.60, name: '밀지마요 III', desc: '전선 진격 +30% (중첩 안 됨)', set: { militiaAdvance: 0.30 } },
    { hp: 80, atk: 8.0, stop: 4.60, name: '지킬게요', desc: '발사 시 0.1%로 영웅 각성 (5웨이브당 1회)', set: { awakenChance: 0.001 } },
  ],
  2: [
    { hp: 110, atk: 12.0, stop: 6.00, name: '초보자행운 I', desc: '사망에 이르는 공격을 받을 시 3%로 체력 1 생존', set: { luckySurvive: 0.03 } },
    ...
    { hp: 134, atk: 14.4, stop: 6.30, name: '초보자행운 II', desc: '사망에 이르는 공격을 받을 시 6%로 체력 1 생존', set: { luckySurvive: 0.06 } },
    ...
    { hp: 158, atk: 16.8, stop: 6.60, name: '초보자행운 III', desc: '사망에 이르는 공격을 받을 시 10%로 체력 1 생존', set: { luckySurvive: 0.10 } },
  ...
  4: [
    ...
    { hp: 535, atk: 58.5, stop: 13.12, name: '방패막기 I', desc: '근처 아군 피해 8% 감소 (중첩 안 됨)', set: { shieldDr: 0.08 } },
    ...
    { hp: 650, atk: 70.0, stop: 13.48, name: '방패막기 II', desc: '근처 아군 피해 12% 감소 (중첩 안 됨)', set: { shieldDr: 0.12 } },
    ...
    { hp: 765, atk: 82.0, stop: 13.85, name: '방패막기 III', desc: '근처 아군 피해 16% 감소 (중첩 안 됨)', set: { shieldDr: 0.16 } },
    { hp: 790, atk: 85.0, stop: 13.92, name: '갑옷관리 III', desc: '본인 피해 20% 감소', set: { selfDr: 0.20 } },
    { hp: 820, atk: 88.0, stop: 14.00, name: '결사항전', desc: '전열 사망 시 3%로 1초 전선 정지 (지속 중첩 없음)', set: { deathLineFreezeChance: 0.03, deathLineFreezeDur: 1 } },
  ],
  5: [
    ...
    { hp: 1190, atk: 136.0, stop: 18.24, name: '넉백공격 I', desc: '공격 시 1%로 적 12px 넉백', set: { knockbackChance: 0.01, knockbackPx: 12 } },
    ...
    { hp: 1430, atk: 160.0, stop: 18.60, name: '넉백공격 II', desc: '공격 시 1%로 적 16px 넉백', set: { knockbackChance: 0.01, knockbackPx: 16 } },
    ...
    { hp: 1650, atk: 182.0, stop: 18.92, name: '넉백공격 III', desc: '공격 시 2%로 적 20px 넉백', set: { knockbackChance: 0.02, knockbackPx: 20 } },
  ...
  6: [
    ...
    { hp: 2350, atk: 267.0, stop: 24.15, name: '위기감지 I', desc: '근처 아군 피격 3% 무효 (중첩 안 됨)', set: { crisisDodge: 0.03 } },
    { hp: 2500, atk: 284.0, stop: 24.30, name: '군단지휘 I', desc: '근처 아군 진격 +20% (중첩 안 됨)', set: { captainAdvance: 0.20 } },
    { hp: 2680, atk: 302.0, stop: 24.45, name: '소드엑스퍼트 II', desc: '공격 시 고정 피해 +100', set: { flatDmg: 100 } },
    { hp: 2860, atk: 320.0, stop: 24.60, name: '위기감지 II', desc: '근처 아군 피격 6% 무효 (중첩 안 됨)', set: { crisisDodge: 0.06 } },
    { hp: 3040, atk: 338.0, stop: 24.75, name: '군단지휘 II', desc: '근처 아군 진격 +35% (중첩 안 됨)', set: { captainAdvance: 0.35 } },
    { hp: 3220, atk: 356.0, stop: 24.90, name: '소드엑스퍼트 III', desc: '공격 시 고정 피해 +130', set: { flatDmg: 130 } },
    { hp: 3380, atk: 372.0, stop: 25.05, name: '위기감지 III', desc: '근처 아군 피격 9% 무효 (중첩 안 됨)', set: { crisisDodge: 0.09 } },
    { hp: 3500, atk: 385.0, stop: 25.20, name: '군단지휘 III', desc: '근처 아군 진격 +50% (중첩 안 됨)', set: { captainAdvance: 0.50 } },
    { hp: 3600, atk: 400.0, stop: 25.40, name: '소드마스터', desc: '공격 틱마다 50%로 1회 추가타', set: { doubleHitChance: 0.50 } },
  ],
  7: [
    { hp: 4600, atk: 520.0, stop: 32.00, name: '신성오라 I', desc: '근처 아군 초당 최대체력 0.5% (중첩 안 됨)', set: { holyRegen: 0.005 } },
    { hp: 4920, atk: 555.0, stop: 32.15, name: '신성망치 I', desc: '공격 시 광역 고정 피해 +100', set: { hammerSplash: 100 } },
    { hp: 5240, atk: 590.0, stop: 32.30, name: '희생정신 I', desc: '근처 피해 15%를 70%로 흡수 (중첩 안 됨)', set: { sacrificeShare: 0.15, sacrificeKeep: 0.70 } },
    { hp: 5600, atk: 630.0, stop: 32.45, name: '신성오라 II', desc: '근처 아군 초당 최대체력 1.0% (중첩 안 됨)', set: { holyRegen: 0.010 } },
    { hp: 5960, atk: 670.0, stop: 32.60, name: '신성망치 II', desc: '공격 시 광역 고정 피해 +160', set: { hammerSplash: 160 } },
    { hp: 6320, atk: 710.0, stop: 32.75, name: '희생정신 II', desc: '근처 피해 25%를 60%로 흡수 (중첩 안 됨)', set: { sacrificeShare: 0.25, sacrificeKeep: 0.60 } },
    { hp: 6680, atk: 750.0, stop: 32.90, name: '신성오라 III', desc: '근처 아군 초당 최대체력 1.5% (중첩 안 됨)', set: { holyRegen: 0.015 } },
    { hp: 7000, atk: 790.0, stop: 33.05, name: '신성망치 III', desc: '공격 시 광역 고정 피해 +220', set: { hammerSplash: 220 } },
    { hp: 7250, atk: 820.0, stop: 33.20, name: '희생정신 III', desc: '근처 피해 35%를 50%로 흡수 (중첩 안 됨)', set: { sacrificeShare: 0.35, sacrificeKeep: 0.50 } },
  ...
  9: [
    { hp: 19000, atk: 2300, stop: 55.00, name: '전군진격 I', desc: '전체 아군 이동 +10% (중첩 안 됨)', set: { armyMove: 0.10 } },
    { hp: 21000, atk: 2580, stop: 56.50, name: '전군공격 I', desc: '전체 아군 공격 +8% (중첩 안 됨)', set: { armyAtk: 0.08 } },
    { hp: 23000, atk: 2860, stop: 58.00, name: '전군방어 I', desc: '전체 아군 피해 8% 감소 (중첩 안 됨)', set: { armyDr: 0.08 } },
    { hp: 25500, atk: 3180, stop: 59.80, name: '전군진격 II', desc: '전체 아군 이동 +18% (중첩 안 됨)', set: { armyMove: 0.18 } },
    { hp: 28000, atk: 3500, stop: 61.60, name: '전군공격 II', desc: '전체 아군 공격 +15% (중첩 안 됨)', set: { armyAtk: 0.15 } },
    { hp: 30500, atk: 3820, stop: 63.40, name: '전군방어 II', desc: '전체 아군 피해 15% 감소 (중첩 안 됨)', set: { armyDr: 0.15 } },
    { hp: 33000, atk: 4140, stop: 65.20, name: '전군진격 III', desc: '전체 아군 이동 +25% (중첩 안 됨)', set: { armyMove: 0.25 } },
    { hp: 35500, atk: 4460, stop: 67.00, name: '전군공격 III', desc: '전체 아군 공격 +22% (중첩 안 됨)', set: { armyAtk: 0.22 } },
    { hp: 37200, atk: 4750, stop: 68.50, name: '전군방어 III', desc: '전체 아군 피해 22% 감소 (중첩 안 됨)', set: { armyDr: 0.22 } },
  ...
  10: [
    ...
    { hp: 77000, atk: 9900, stop: 104.0, name: '광휘', desc: '영웅 생존 시 아군 공/방 +25% (중첩 안 됨)', set: { heroArmyAtk: 0.25, heroArmyDr: 0.25 } },
    { hp: 81000, atk: 10400, stop: 106.0, name: '광란', desc: '영웅 생존 시 적 공/이속 -25% (중첩 안 됨)', set: { enemyAtkDebuff: 0.25, enemySpdDebuff: 0.25 } },
    {
